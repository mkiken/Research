...
e:(nm:plainid {return { type: "Variable", name: nm }; }
	/ [`] str:stringLiteral [`] __ { return { type: "Identifier2", name: '`' + str + '`'}; }){/*console.error("id is %j %d", e, cExpression);*/return e;}
...
Bindings = OPPAREN bd:Binding bds:(COMMA Binding)* el:(COMMA ExprEllipsis)? CLPAREN {
  var result = [bd];
...
/* | Pattern3 */
Pattern2 = id:varid pt:(AT Pattern3)? {return {type: "PatternBinder", id:id, pt:ftr(pt, 1)};}
/ Pattern3
